...
<div class="super_container">
	...
	<div class="home">
		...
		<div class="home_background parallax-window" data-parallax="scroll" data-image-src="images/badak.jpg" data-speed="0.8"></div>
		<div class="container">
			<div class="row">
				<div class="col">
					<div class="home_content">
						<div class="home_content_inner">
							<div class="home_title">Community
							@auth
                            <a style="position: absolute; right: 5px; background:#fe435b" href="{{ route('addkomunitas') }}" class="button">Add Community</a>
							@endauth
							</div>
		...
		<div class="container">
			<div class="row">
				<div class="col">
					...
					<div class="contact_title">Cari komunitas pecinta alam</div>
					<div class="contact_subtitle">diseluruh Indonesia</div>
				</div>
			</div>
        <br>
        <br>
