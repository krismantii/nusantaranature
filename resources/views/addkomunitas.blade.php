        ...
        <div class="wrapper wrapper--w790">
            <div class="card card-5">
                <div class="card-heading">
                    <h2 class="title">Register your Community</h2>
                </div>
                <div class="card-body">
                    <form method="POST" action="{{route('addkomunitasku')}}" class="login100-form validate-form" enctype="multipart/form-data">
                    @csrf    
                        <div class="form-row">
                        ...
                        <div class="form-row">
                            ...
                            <div class="value">
                                <div class="input-group">
                                    <input class="input--style-5" type="text" name="telfon" id="telfon" required>
                                </div>
                            </div>
                        </div>
                        <div class="form-row">
